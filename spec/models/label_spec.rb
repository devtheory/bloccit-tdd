...
RSpec.describe Label, type: :model do
  ...
  let(:post) { topic.posts.create!(title: "New Post title", body: "New Post Body that's long enough", user: user)}
  ...
  describe "labelable" do
    it "allows the same label to be associated with a different topic and post" do
      ...
      topic_label = topic.labels.first
      post_label = post.labels.first
  ...
  describe ".update_labels" do
    it "takes a comma delimited string and returns an array of Lables" do
