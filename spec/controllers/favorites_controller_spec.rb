...
RSpec.describe FavoritesController, type: :controller do
  ...
  context "guest user" do
    ...
    describe "DELETE destroy" do
      it "redirects to the sign in view" do
        favorite = my_user.favorites.create(post: my_post)
  ...
  context "signed in user" do
    ...
    describe "POST create" do
      ...
      it "creates a favorite for the user and specified post" do
    ...
    describe "DELETE destroy" do
      ...
      it "unfavorites a post" do
        favorite = my_user.favorites.where(post: my_post).create
        expect(my_user.favorites.where(post: my_post).first).not_to be_nil
